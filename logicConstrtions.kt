...
fun usualCompare(a: Int, b: Int, condition: (Int, Int) -> Boolean) {
    if (condition(a, b)) {
        println("Числа равны")
    } else if (a < b) {
...
fun specifiedCompare(a: Int, condition: (Int) -> Boolean) {
    if (condition(a)) {
...
fun currencyConverter(rub: Int, condition: (Int) -> Boolean) {
    println(
        "Введите Валюту:\n" +
                "1. Доллары\n" +
                "2. Евро\n" +
